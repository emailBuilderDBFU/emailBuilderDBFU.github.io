export let categoryMetadata = [{
	...
	"topics":[{
		...
		"paragraphs":[{
			...
			"requirementTypes":["Dog Name","Dog Gender", "Author"]
		}],
		"subTopics":[]
	},{
		"name":"Renamed dog?",
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "Unfortunately we don’t offer basic obedience courses at APA at this time, due to limited resources. If you have any specific issues you'd like help with (like jumping, chewing, separation anxiety, etc), our behavior team can provide advice and resources (documents, how-to videos, etc). Otherwise, if you're just looking to get your dog in a hands-on obedience class learning basics like sit, stay, down, etc., we recommend looking at local training facilities. While APA doesn’t have an official list of recommended trainers, a few that are typically well-reviewed are Train with Cerberus, The Dog Alliance, Zoom Room, and Taurus Training Academy. You could also reach out to other adopters on the \"Austin Pets Alive! Adopters\" page on Facebook for trainer recommendations. This Facebook group is a really supportive community, comprised of all APA! adopters, and they have a wealth of knowledge and experience with local facilities. \n",
			"requirementTypes":[]
		}],
		"subTopics":[]
	}, {
		...
		"default Value": false,
		"paragraphs":[{
			"text": "Thanks for asking about virtual training for [name]! I've attached a series of our training videos that teach basic obedience skills. I would start by teaching [him/her] eye contact, sit with duration, and loose leash walking. Eye contact is an essential, foundational skill that will teach [him/her] to check-in with you for guidance and make it easier to teach [him/her] other skills. To teach eye contact as a rewardable behavior, I've attached two videos: Marker Training for Eye Contact and Reinforcing Eye Contact with Made Ya Look Game. \n\nOnce [he/she] has mastered eye contact, sit with duration, and loose leash walking it's time to move on to working walk (aka “Heel”) and sit with distance and distractions. I've attached videos for each below.\n\nFinally, recall is a great skill to teach. I recommend buying a long leash - 15-20 feet to use while teaching this skill. This will allow you to increase the distance from [name] and be able to \"recall\" [him/her] to you without having [him/her] off-leash.\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}, {
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "I’m glad to hear that [name] is settling in well in your home. We love these kinds of updates! If any behaviors do pop up that you have questions about, or want to work on, don’t hesitate to reach out. We are here as a resource and support system for you for [name]’s whole life. Thanks again for adopting!\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	},	{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "I’m glad to hear that [name] is settling in well in your home. We love these kinds of updates! If any behaviors do pop up that you have questions about, or want to work on, don’t hesitate to reach out. We really appreciate fosters like you. Thanks for opening your home to this pup!\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "A drag leash is just any normal, preferably lightweight, leash that you clip to [his/her] collar but don’t hold; let it drag behind [him/her]. Keeping that on your pup all the time, even indoors, allows you to have a quick and easy point of contact with [him/her]. It is also not as invasive as grabbing for the collar; you simply can pick up the handle of [his/her] drag leash and avoid reaching towards [his/her] face, which can be intimidating or overstimulating for some dogs. \n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "See about increasing [his/her] exercise. A tired dog is less likely to be worried about the small things and more likely to snooze the day away. Beyond just increasing walk times (which you can do, if possible), try engaging [him/her] with toys. Can you get [him/her] to play tug, or fetch? Or even just chase you around the home?  Any of these kinds of exercises are great ways to easily expend some energy while also lowering [his/her] stress in the home. [He/She] is not going to be worrying about the outside world if [he/she] is trying to win a game of tug. \n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}, {
		...
		"default Value": false,
		"paragraphs":[{
			"text": "\"Mental\" exercise can be an effective way to burn some steam and channel [name]’s focus into something productive as well. One of the easiest ways to mentally enrich a dog is by using their food. You could stop feeding [him/her] with a regular bowl and instead, make [him/her] \"work\" for [his/her] food at meal times by feeling [him/her] with a \"puzzle\" toy, or even just scattering [his/her] kibble on the ground to sniff out. This adds a little challenge to [his/her] meal, occupies [his/her] focus, and is completely hands-off for you. Check out the \"Canine Enrichment\" document I’ve attached for more details on puzzle toys, snuffle mats, and other ways to engage [name] dog mentally.\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "\"Mental\" exercise can be an effective way to burn some steam when you simply don’t have the capability to physically wear your dog out. One of the easiest ways to mentally enrich a dog is by using their food. You could stop feeding [him/her] with a regular bowl and instead, make [him/her] work for [his/her] food at meal times by feeling [him/her] with a \"puzzle\" toy. This adds a little challenge to [his/her] meal, occupies [his/her] focus, and is completely hands-off for you. You can also engage [his/her] innate scavenging instincts by simply scattering small bits of treats around and letting [him/her] sniff them out, or by using a \"snuffle mat.\" Check out the “Canine Enrichment” document I’ve attached for more details on puzzle toys, snuffle mats, and other ways to engage your dog mentally. \n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
		},	{
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "I would recommend leaving a lightweight leash on [him/her] all the time for a while, and letting it drag on the ground, even while inside. We call that a \"drag leash.\" Whenever [he/she] jumps on something inappropriate, grab the drag leash and guide [him/her] off. At the same time, use a command word like \"off\". Pair this word with the act of guiding [him/her] off the furniture, and [he/she] will start associating \"off\" with physically moving off of whatever [he/she] is on. Once you practice this exercise enough, [name] will know to get down from the furniture just hearing the word \"off\" and you will not need to keep the drag leash on [him/her] anymore.\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
		},	{
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "The behavior of pulling, barking, or growling on leash in response to other animals, people, etc is called \"on leash reactivity.\" This behavior is actually really common in dogs, and there are tried and true methods to work through it. To start, are you walking [him/her] just on [his/her] normal collar, or are you using any \"gear\" like a harness or Gentle Leader? Sometimes just getting some equipment can work wonders on dogs. We recommend either a Gentle Leader or a front clipping harness like an Easy Walk. If you want to talk in more detail about pros and cons of different equipment for walking, just let me know and we can talk through what is out there. \n\nWhile we can’t directly change how [name] feels in response to [his/her] triggers on leash, we can teach [him/her] a more appropriate response. We want to teach “replacement behaviors” that [name] will do instead of reacting. Typical replacement behaviors include having your dog sit calmly next to you and giving eye contact (aka “checking in”) when [he/she] sees the dog/person/etc that usually elicits [his/her] reactivity. We basically have to teach [him/her] impulse control - to think before [he/she] gives in to [his/her] desire to react. Don’t expect [name] to be able to perform these replacement behaviors right away, but with some time and effort on your part, [he/she] will learn that this new behavior is the preferable option. The first step you'll want to do is work on [him/her] being able to perform \"sit\" on verbal in a calm, quiet environment (like inside your home). Check out the videos I attached to this email on working on sitting with distractions and for duration. I’m going to attach another video that goes over teaching that eye contact is a rewardable behavior; this is really helpful because if [he/she] is looking at you for treats, [he/she] is not reacting at the people/dogs.  \n\nOnce [he/she] can do that consistently, we can start working through [his/her] behavior on leash. When you take [him/her] on walks, I suggest you start bringing treats along. Make sure they are high enough in value to [him/her] that she will be interested in them even with distractions around (this may mean the treats need to be cheese, chicken, or some other special thing [he/she] doesn't usually get). When you see a person or dog, hopefully before [he/she] sees said person or dog, first try to create some distance - move off to the side of the trail, cross the street, just add some buffer space. Next ask [him/her] to \"sit\" and then reward [him/her] with treats and praise for sitting. Continue to make [him/her] hold [his/her] sit (you can use the \"stay\" command if [he/she] knows it) while the distraction passes by. Any time [he/she] looks at you instead of the dog or person, heavily praise and reward [him/her] with treats. Once they are gone, release [him/her] from holding [his/her] sit and carry on your walk. \n\nThe key to this training technique is consistency and a foundation in the basics. If [he/she] can't hold a sit/stay at home without distractions, there is very little hope [he/she] will be able to hold it while out on walks in the exciting world. So depending on where [he/she] is at in [his/her] obedience training, you may need to start working on this just in your home, then progress to the outdoors.\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
		},	{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "Pulling a lot on leash can definitely make walks stressful and not fun for the human at the other end of the leash. Luckily, there are lots of training techniques that can help teach [name] how to be a little more polite on leash. To start, are you walking [him/her] just on [his/her] normal collar, or are you using any \"gear\" like a harness or Gentle Leader? Sometimes just getting some equipment can work wonders on dogs. We recommend either a Gentle Leader or a front clipping harness. The harnesses that clip in the front deter pulling more effectively than more standard harnesses that clip in the back. Next, when you’re walking, we recommend bringing along some high value treats, like cheese, chicken, or hot dogs. You’re going to have to be communicating with your dog what is and is not \"good\" behavior on leash; having treats on hand will allow you to reinforce the good behavior and teach [name] what you want faster. When [he/she] is walking politely on leash, praise [him/her] and give [him/her] a treat. This will teach [him/her] that good things come to [him/her] when [he/she] is by your side. I'm also going to attach a video that goes over how to react when [he/she] is pulling on leash. Check it out and let me know if you have any questions.\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "Potty training takes time, consistency, and above all, patience; it can certainly be frustrating at times. I'm attaching a document that goes through in depth some tips on potty training specifically for adult dogs. The most important takeaways from that document are to set a schedule/routine and take [him/her] out often. Dogs thrive on routines, so getting [him/her] to a point where [he/she] expects to be let out will go a long way to motivate [him/her] to hold [his/her] business.\n\nMake sure you praise [him/her] when [he/she] goes outside, so [he/she] knows that going potty outside is something that results in a positive experience. You can also attach a lightweight leash that is always on [him/her], dragging on the ground. If/when [he/she] does have an accident indoors, try to catch [him/her] in the act and pick up that leash to take [him/her] outside immediately, where you reward [him/her] for finishing up [his/her] business. Don’t punish or scold [him/her] if [he/she] does potty indoors. If you scold [him/her] for going indoors, [he/she] could start being scared to go potty in front of you at all, even outdoors, which is definitely not what we want. \n\nWith these techniques, [he/she] learns that pottying indoors gets interrupted, but pottying outdoors gets rewarded! I want to note that even if you’re doing everything right, it can take a while for [him/her] to fully understand and master potty training, so don’t worry if [he/she] has slip ups sometimes. Just continue to follow the guidelines, reward good choices, and interrupt [him/her] when [he/she] potties indoors.\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}, {
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "Another option to curb mouthy behavior is to teach an incompatible behavior, like sit. Once [he/she] knows sit, you can ask [him/her] to sit when [he/she] starts to get in that excitable state. This redirects [his/her] attention to something [he/she] can be praised for, and keeps [him/her] from nipping or jumping. I've attached our video for teaching sit with duration and distractions. You’ll want to practice sit when [he/she] is calm before expecting [him/her] to be able to perform this trick when excited, so a little preparation is needed. \n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"topics":[{
		...
		"defaultValue": false,
		"paragraphs": [{
			"text": "I wanted to reach out and learn about [his/her] behavior in the time you have had [him/her]. This information will be really helpful for us to update [his/her] file, know how to work with [him/her], and match [him/her] to [his/her] next adoptive home. \n\nHow does [name] do meeting new people in your home? In public? Has [he/she] been around kids and if so how does [he/she] do? What about dogs? Cats? How does [he/she] do when left home alone? Are there any specific behavioral issues you have experienced? If so, can you describe those please? \n\nThanks for taking the time to look through these questions, we really appreciate any additional information you can provide; this insight is really helpful to finding a good home for [name]. Once we get a response to this, we can go forward with the next step in the return process.\n",
			"requirementTypes": ["Dog Name","Dog Gender"]
		}],
		"subTopics": []
	}, {
		"name": "Dog/dog incident, injury to resident dog",
		"key":"39",
		"default Value": false,
		"paragraphs":[{
			"text": "I’m sorry to hear about the incident between [name] and your resident dog. I would appreciate any information about the context around that incident, and about [name] and your resident dog's behavior together beyond that. This information will help us know how to work with [name] on [his/her] behaviors and place [him/her] in a safe and successful home. To start, could you walk me through the situation that resulted in their scuffle? Was it while they were eating, or was there a toy or treat around that one could have been guarding from the other? Were they playing and it tipped over into a scuffle? How did the scuffle end; did they split up on their own, or did you have to interfere? Was it a mutual scuffle at this point, or was your dog trying to move away? After they had separated, did [name] stay agitated or did [he/she] try to re-engage with your dog? How severe were the wounds to your dog; did you take him/her to the vet? In general, how had they been together before this incident? Did they co-exist well, play together, seem to enjoy each other, or did they seem more uncomfortable around each other? I know this is a lot of information to ask of you, but really any context would be great. Understanding [his/her] triggers and behaviors is an important part of beginning the process of finding [him/her] a well-suited home.\n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"topics":[{
		...
		"defaultValue": false,
		"paragraphs": [{
			"text": "I’m sorry to hear [name] is struggling with separation anxiety. This behavior is not all that uncommon, especially dogs that are adjusting to big life changes like settling in to a new home. Dogs like routines; [name]’s life recently has not had all that much consistency, and that could be contributing to some of [his/her] anxiety. Sometimes we see this kind of anxiety reduce on its own once the dog has some \"decompression\" time in the home. Other times, dogs need a little help to realize that being alone isn’t all that scary. I am going to attach a resource that walks through some techniques to help curb separation anxiety. It will take some time, consistency, and patience on your part to get [him/her] to a point where [he/she] can be left alone without anxiety, but it is possible.\n",
			"requirementTypes": ["Dog Name","Dog Gender"]
		}],
		"subTopics": []
	},{
