export let categoryMetadata = [{
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "<p>The behavior you're describing sounds like what we call \"overarousal.\" It basically means [he/she] gets so excited that [he/she] kind of loses the ability to calm down on [his/her] own.</p><p>There are a few ways to handle this, but to start I'd recommend leaving a drag leash on [name]. A drag leash is just any normal, preferably lightweight, leash that you clip to [his/her] collar but don’t hold; let it drag behind [him/her]. Keeping that on [name] all the time, even indoors, allows you to have a quick and easy point of contact with [him/her]. It is also not as invasive as grabbing for the collar; you simply can pick up the handle of [his/her] drag leash and avoid reaching towards [his/her] face, which can be overstimulating for some dogs and can amp them up more. </p>",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	},{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "<p>When [he/she] starts getting worked up, grab [his/her] drag leash and calmly walk [him/her] to a \"time out\" zone. This zone should be set up in advance; it could be a laundry room, bathroom, or some other closed-off area that you've dog proofed. Leave [him/her] in [his/her] time out zone for a few minutes, then let [him/her] out. Check out <a href=\"https://docs.google.com/document/d/1haMs82fkxCY2Ld7HCSA8-RMn_yJPDKNpGyK64O0vs_g/edit?usp=sharing\">this document</a> for more information on time outs.</p><p>Using this \"time out\" technique allows [name] to settle down on [his/her] own, because [he/she] doesn't have anything exciting to keep stimulating [him/her] when [he/she]'s already over [his/her] threshold of what [he/she] can handle. You need to do this consistently every time [he/she] starts showing this behavior. </p>",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "<p>Dogs scent mark for a variety of reasons, including to claim territory, to identify themselves to other dogs and let them know they’ve been there, and in response to frustration, stress or an anxiety-provoking situation. Here are a few ways to train your pup to stop doing this: </p><p><u><strong>Use an Enzyme cleaner</u></strong>: First, I would be sure to clean all areas/places in your home that [name] has marked with an enzyme cleaner. Dogs are scent oriented so even if people can't smell things, dogs still can and it can encourage them to mark or potty in that spot again, and the enzyme cleaner helps remove those smells.</p><p><u><strong>Keep a \"drag leash\" on [him/her]</u></strong>: A drag leash is just any normal, preferably lightweight, leash that you clip to [his/her] collar but don’t hold; let it drag behind [him/her]. Keeping that on your pup all the time, even indoors, allows you to have a quick and easy point of contact with [him/her]. It is also not as invasive as grabbing for the collar; you simply can pick up the handle of [his/her] drag leash and avoid reaching towards [his/her] face, which can be intimidating or overstimulating for some dogs. If you see [him/her] marking or about to mark, interrupt [him/her], grab that leash, and quickly escort [him/her] outside. </p><p><u><strong>Closely monitor [him/her]</u></strong>: This one is pretty obvious but takes the most work. Don't let [him/her] interact with things [he/she] might mark without you being around. If [he/she] starts to mark, make a startling noise (like a loud clap) then grab [his/her] drag leash and immediately escort [him/her] outside as I mentioned above. Interrupting [him/her] every time you see [him/her] mark inside is critical. If you find spots that [he/she] has marked but it is after the fact, don't correct [him/her] - it is too late at that point for [him/her] to understand why [he/she] is getting punished. </p><p><u><strong>Try a Belly Band</u></strong>: A belly band is basically an elastic strap that wraps around [his/her] stomach and works like a diaper. It holds the pee and the dog can usually feel it and doesn't like it. And it will prevent [him/her] from marking in the same spot.</p><p><u><strong>Restrict [his/her] access</u></strong>: When you can't monitor [him/her], don't let [him/her] have the full range of the house. We need to break the habit of marking indoors, which can only be done if [he/she] doesn't get to practice the behavior. When you aren't watching [him/her], you could crate [him/her] or keep [him/her] in a smaller area like the kitchen, or restrict [him/her] to specific areas using an <a href=\"https://www.amazon.com/MidWest-Foldable-Metal-Exercise-Playpen/dp/B000H8YTJI\">x-pen</a> or a baby gate. You could also loop a leash around your waist and clip it to [him/her], so that [he/she] is always right by your side while you work through this issue.</p><p>Overall, the main goal is to catch [him/her] in the act and interrupt [him/her], and not allow [him/her] free range to practice this behavior when you aren't watching. Additionally, you can check out our <a href=\"https://docs.google.com/document/d/1XBXnvgKw4sQOktYx93bHkgrzMjIFX3-UBEg6-_3STZw/edit?usp=sharing\">document on house training</a> which goes through some tips on potty training specifically for adult dogs. I want to note that even if you’re doing everything right, it can take a while for [him/her] to fully understand. </p>",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	},	{
		"name": "Pottying Indoors after Walks",
		"key":"31",
		"default Value": false,
		"paragraphs":[{
			"text": "<p> First, I'd like to learn a little more about [name]’s accidents.  Do you live in a house or apartment? Where do you take [him/her] to potty? Is it quiet or are there distractions, like other dogs nearby or traffic? Does [he/she] seem comfortable outside or does [he/she] want to go back in the house right away?</p><p>Some dogs have particular habits around going potty - like they have to go on a walk to do it or they can't have anyone looking at them. Have you noticed any patterns with [name]? Some dogs are too shy to go in front of a person or are too distracted by or fearful of the great outdoors. This may be impacting [his/her] ability to go potty outside - [he/she] may not feel safe enough to do [his/her] business or it may be too exciting. When [he/she] goes potty indoors does [he/she] do it in front of you? If not, it is possible [he/she] is waiting until [he/she] can be alone to go because in the past (before you) [he/she] was punished for going potty in front of a person inside and that has caused [him/her] to associate going potty in front of a person with being punished. Answers to these questions might help us figure out, more specifically, what is going on with [name], but in the meantime, I have some suggestions.</p><p> First, make sure you praise [him/her] and reward [him/her] with treats when [he/she] does go outside so [he/she] knows that going potty outside is something that results in a positive experience. If we can start to connect going outside with something [he/she] really wants - treats and praise - it will go a long way in changing [his/her] behavior. Is [he/she] food motivated? If so, that will help! Find a special treat, something [he/she] really loves, and use it only for when [he/she] goes potty outside. We call these \"high value\" treats. Cheese, plain chicken (no spices), and hot dogs are high value treats that many dogs love. </p><p> Next, I’d suggest attaching a lightweight leash that is always on [him/her] indoors, dragging on the ground. If/when you notice signals that [he/she] is about to go (circling, sniffing, etc) or [he/she] does have an accident indoors, try to catch [him/her] in the act and pick up that leash to take [him/her] outside immediately, where you reward [him/her] for finishing up [his/her] business with high value treats. Continue to not punish or scold [him/her] if [he/she] does potty indoors.</p><p>With these techniques, [he/she] learns that pottying indoors gets interrupted, but pottying outdoors gets rewarded! I want to note that even if you’re doing everything right, it can take a while for [him/her] to fully understand and master potty training. Just continue to follow the guidelines, reward good choices, and interrupt [him/her] when [he/she] potties indoors. I've attached our documents for potty training adult dogs with more detailed information <a href=\"https://docs.google.com/document/d/1XBXnvgKw4sQOktYx93bHkgrzMjIFX3-UBEg6-_3STZw/edit?usp=sharing\">here</a> and <a href=\"https://docs.google.com/document/d/1NpYihBIUFEEDWOWpcc39QG-dsWxxRbOJSpo4lBaoqK0/edit?usp=sharing\">here</a>. </p><p> My next suggestion to try is to ignore [him/her] when you take [him/her] out to go potty. Walking around and/or being looked at can be too intense for some dogs if they are fearful and they won't relax enough to potty. If [he/she] is on leash, I would use at least a six foot leash so [he/she] can step a bit away. Pretend to look at your phone so that [he/she] feels comfortable going potty near you. If [he/she] does, give [him/her] a high-value treat, praise [him/her] and take [him/her] back in straight away and let [him/her] go back to [him/her] safe spot to recover. Once [he/she] has peed and pooped outside once, it should get easier, but you will have to wait until [he/she] is feeling comfortable with the routine so trying to make it as consistent and non-scary as possible will help.  </p><p> If [he/she] seems comfortable outside, it could be that [he/she] just doesn't have the knowledge that you would prefer for [him/her] to go outside. As [name] is learning the right and wrong places to go potty you will need to restrict [his/her] free roam in your home. Dogs don’t typically like to potty in the same places they eat and hang out. Giving [him/her] access to a smaller area will help curb [his/her] behavior and give you less space to monitor. Close bedroom doors and block access to other parts of your house using baby gates or an x-pen to keep [name] in the same general area with you. It is important that you are aware and mindful of what [he/she] is doing while [he/she] is in this space with you so you can catch [him/her] in the process and take [him/her] outside. If you are working, cooking, or distracted doing a task that takes your focus then it is still possible for [him/her] to have an accident in the area with you. Therefore, if you know you won’t be able to pay close enough attention to [him/her], you’ll need to restrict [his/her] freedom even more to reduce the risk of an accident. Using a crate is a great option for times like this but a laundry room or bathroom are also good choices since they usually have hard surfaces to make cleaning easier should there be an accident. Once you are able to monitor [name] more closely [he/she] can rejoin you in a larger space of the house. The attached documents have more information on this process as well as a link to our crate training advice.</p>",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}, {
