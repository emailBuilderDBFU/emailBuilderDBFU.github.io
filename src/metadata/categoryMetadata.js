export let categoryMetadata = [{
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "<p>Pulling a lot on leash can definitely make walks stressful and not fun for the human at the other end of the leash. Luckily, there are lots of training techniques that can help teach [name] how to be a little more polite on leash. To start, are you walking [him/her] just on [his/her] normal collar, or are you using any \"gear\" like a harness or Gentle Leader? Sometimes just getting some equipment can work wonders on dogs. We recommend either a Gentle Leader or a front clipping harness. The harnesses that clip in the front deter pulling more effectively than more standard harnesses that clip in the back. Next, when you’re walking, we recommend bringing along some high value treats, like cheese, chicken, or hot dogs. You’re going to have to be communicating with your dog what is and is not \"good\" behavior on leash; having treats on hand will allow you to reinforce the good behavior and teach [name] what you want faster. When [he/she] is walking politely on leash, praise [him/her] and give [him/her] a treat. This will teach [him/her] that good things come to [him/her] when [he/she] is by your side. I'm also going to attach a video that goes over how to react when [he/she] is pulling on leash. Check it out and let me know if you have any questions.</p>",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
