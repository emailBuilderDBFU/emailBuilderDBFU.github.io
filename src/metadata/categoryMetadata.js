export let categoryMetadata = [{
	...
	"topics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "The behavior of pulling, barking, or growling on leash in response to other animals, people, etc is called \"on leash reactivity.\" It's actually really common in dogs, and there are tried and true methods to work through it. I'm going to attach a document that goes over the basics on how to curb [his/her] rude behavior, but I'll touch on some points in this email too. To start, are you walking [him/her] just on a normal collar, or are you using any \"gear\" like a harness or Gentle Leader? Sometimes just getting some equipment can work wonders on dogs. We recommend either a Gentle Leader or a front clipping harness like an Easy Walk. If you want to talk in more detail about pros and cons of different equipment for walking, just let me know and we can talk through what is out there. \n\nThe goal of on leash reactivity training is to teach [name] a more appropriate response when [he/she] sees dogs on leash. We want to teach “replacement behaviors” that [name] will do instead of reacting. This is basically teaching [him/her] impulse control - to think before [he/she] gives in to [his/her] desire to react. A typical replacement behavior is [name] sitting by your side and \"checking in\" with you, aka looking at your face/giving you eye contact. The first step you'll want to do is work on [him/her] being able to perform \"sit\" on verbal in a calm, quiet environment (like inside your home). Check out the links in the document for how we teach sit and eye contact to get started. \n\nOnce [he/she] can do that consistently, we can start working through [his/her] behavior on leash. Like I said above, when you take [him/her] on walks, bring some high value treats along. When you see a person or dog, hopefully before [he/she] sees said person or dog, first try to create some distance - move off to the side of the trail, cross the street, just add some buffer space. Next ask [him/her] to \"sit\" and then reward [him/her] with treats and praise for sitting. Continue to make [him/her] hold [his/her] sit (you can use the \"stay\" command if [he/she] knows it or follow the techniques described in the APA sit videos) while the distraction passes by. Any time [he/she] looks at you instead of the dog or person, heavily praise and reward [him/her] with treats. Once they are gone, release [him/her] from holding [his/her] sit and carry on your walk.\n\nThe key to this training technique is consistency and a foundation in the basics. If [he/she] can't hold a sit/stay at home without distractions, there is very little hope [he/she] will be able to hold it while out on walks in the exciting world. So depending on where [he/she] is at in [his/her] obedience training, you may need to start working on this just in your home, then progress to the outdoors. Read through that document and start giving these techniques a go. Let me know if you have any questions on how to implement this. \n",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
		},	{
