export let topicMetadata = [{
	...
	"default Value": false,
	"paragraphs":[{
		"text": "I’m glad to hear that [name] is settling in well in your home. We love these kinds of updates! If any behaviors do pop up that you have questions about, or want to work on, don’t hesitate to reach out.",
		"requirementTypes":["Dog Name","Dog Gender"]
	}],
	"subTopics":[{
		"name": "Adopter",
		"default Value": false,
		"paragraphs":[{
			"text": "We are here as a resource and support system for you for [name]’s whole life. Thanks again for adopting!",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	},	{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "We really appreciate fosters like you. Thanks for opening your home to this pup!",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"name": "Desensitization and Counter Condititoning - Car",
	"default Value": false,
	"paragraphs":[{
	...
	"subTopics":[{
		...
		"default Value": false,
		"paragraphs":[{
			"text": "I’m sorry that [name] is pulling a lot on leash. That can definitely make walks stressful and not fun for the human at the other end of the leash. Luckily, there are lots of training techniques that can help teach [name] how to be a little more polite on leash. To start, are you walking [him/her] just on [his/her] normal collar, or are you using any \"gear\" like a harness or Gentle Leader? Sometimes just getting some equipment can work wonders on dogs. We recommend either a Gentle Leader or a front clipping harness like an Easy Walk. If you want to talk in more detail about pros and cons of different equipment for walking, just let me know and we can talk through what is out there. Next, when you’re walking, we recommend bringing along some high value treats, like cheese, chicken, or hot dogs. You’re going to have to be communicating with your dog what is and is not \"good” behavior on leash; having treats on hand will allow you to reinforce the good behavior and teach [name] what you want faster. The technique we use at APA to teach dogs not to pull uses \"Drop and Go’s.\" I’m going to attach a couple videos to this document that walks through how to implement \"Drop and Go’s\" and polite leash skills in general. Please watch those, and then get back to me. If you have any questions on what they videos cover, I can break it down in more detail for you.",
			"requirementTypes":["Dog Name","Dog Gender"]
		}],
		"subTopics":[]
	}]
	...
	"subTopics": [
	{
		...
		"name":"RR - Specific Behavior DBFU Reminder",
		"defaultValue": false,
		"paragraphs": [{
	...
	"name": "Transition Issues - Not Eating",
	"default Value": false,
	"paragraphs":[{
